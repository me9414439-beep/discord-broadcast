module.exports = {
    ...
    server: {
        guildId: '1430319019436802100',         // ايدي السيرفر
        broadcastRoleId: '1431293478150733885', // ايدي الرول اللي يستخدم عليها البوت
        reportChannelId: '1431309313388974264' // ايدي الروم اللي يرسل فيه البوت التقارير
    },
    broadcast: {
